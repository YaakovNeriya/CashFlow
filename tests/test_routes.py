...
@patch('app.routes.forecast.get_all_recurring', return_value=[])
@patch('app.routes.forecast.get_all_transactions', return_value=[])
@patch('app.routes.forecast.get_settings', return_value={'initial_balance': 1000.0, 'warning_threshold': 500.0})
def test_forecast_returns_200(mock_settings, mock_tx, mock_rec, client):
    response = client.get('/')
    assert response.status_code == 200


@patch('app.routes.operations.get_all_recurring', return_value=[])
@patch('app.routes.operations.get_all_transactions', return_value=[])
def test_operations_page_returns_200(mock_tx, mock_rec, client):
    response = client.get('/operations')
    assert response.status_code == 200


@patch('app.routes.settings.get_settings', return_value={'initial_balance': 1000.0, 'warning_threshold': 500.0})
...
@patch('app.routes.operations.get_all_recurring', return_value=[])
@patch('app.routes.operations.get_all_transactions', return_value=[])
@patch('app.routes.operations.add_transaction', return_value=None)
...
@patch('app.routes.operations.delete_transaction', return_value=None)
...
@patch('app.routes.operations.get_all_recurring', return_value=[])
@patch('app.routes.operations.get_all_transactions', return_value=[])
@patch('app.routes.operations.add_recurring', return_value=None)
...
@patch('app.routes.operations.delete_recurring', return_value=None)
...
@patch('app.routes.settings.get_settings', return_value={'initial_balance': 1000.0, 'warning_threshold': 500.0})
@patch('app.routes.settings.update_settings', return_value=None)
